            ...
            <div className='container mx-auto py-5 px-6 '>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='my-2'>
                        ...
                        <input value={form.name ? form.name : ""} onChange={handleChange} type="text" name='name' id="name" className="block w-full p-2 text-white border border-gray-300 rounded-lg bg-gray-700 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                    {/* input for email */}
                    <div className="my-2">
